...
class WhiteFactory(Factory):
  ...
  @classmethod
  def create_white_dog(self, weight=3, hunger=5):
    return WhiteDog(weight=weight, hunger=hunger)

  @classmethod
  def create_white_cat(self, weight=3, hunger=5):
    return WhiteCat(weight=weight, hunger=hunger)

class BlackFactory(Factory):

  @classmethod
  def create_black_cat(self, weight=3, hunger=5):
    return BlackCat(weight=weight, hunger=hunger)

  @classmethod
  def create_black_dog(self, weight=3, hunger=5):
